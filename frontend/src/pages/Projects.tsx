        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <div className="text-3xl font-bold text-gray-900">{projects.filter(p => p.status === 'active').length}</div>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div className="relative">
                    {loading ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <Button onClick={loadProjects} className="bg-orange-600 hover:bg-orange-700 text-white">
                                Retry
                            </Button>
                        </div>
                        ...
                        <div className="p-16 text-center">
                            ...
                            <p className="text-gray-500 mt-1">Industrial trade thrives on project grouping. Create your first project site.</p>
                            <Button
                                onClick={() => {/* TODO: Create Project Modal */ }}
